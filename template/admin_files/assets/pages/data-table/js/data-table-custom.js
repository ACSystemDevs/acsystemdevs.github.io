$(document).ready(function() {
    ...
    // $("div.doc-toolbar").html('<button class="btn btn-sm btn-info">Add Doctor</button>');
    // $("div.serv-toolbar").html('<button class="btn btn-sm btn-info">Add Service</button>');
    // $("div.pack-toolbar").html('<button class="btn btn-sm btn-info">Add Package</button>');
