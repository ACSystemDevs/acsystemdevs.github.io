...
<body>
		...
		<div class="container">
			<div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
				<div class="col-lg-3 pr-4 align-items-center">
					<a class="navbar-brand" href="index.html">Bethany <span>Hospital</span> Inc.</a>
				</div>
		...
		<div class="container d-flex align-items-center">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item"><a href="doctor.html" class="nav-link">Patient & Guests</a></li>
					<li class="nav-item"><a href="department.html" class="nav-link">What's New?</a></li>
					<li class="nav-item"><a href="pricing.html" class="nav-link">Services</a></li>
					<li class="nav-item"><a href="blog.html" class="nav-link">Doctors</a></li>
					<li class="nav-item"><a href="blog.html" class="nav-link">Careers</a></li>
	...
	<section class="home-slider owl-carousel">
		<div class="slider-item" style="background-image:url(<?php echo base_url();?>template/images/bg_1.jpg);" data-stellar-background-ratio="0.5">
		...
		<div class="slider-item" style="background-image:url(<?php echo base_url();?>template/images/bg_2.jpg);">
			<div class="overlay"></div>
			<div class="container">
				<div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
					<div class="col-md-6 text ftco-animate">
	...
	<section class="ftco-section ftco-no-pt ftc-no-pb">
		<div class="container">
			<div class="row no-gutters">
				<div class="col-md-5 p-md-5 img img-2 mt-5 mt-md-0" style="background-image: url(<?php echo base_url();?>template/images/about.jpg);">
				</div>
				<div class="col-md-7 wrap-about py-4 py-md-5 ftco-animate">
					<div class="heading-section mb-5">
						<div class="pl-md-5 ml-md-5">
							<span class="subheading">About Bethany Hospital Inc</span>
							<h2 class="mb-4" style="font-size: 28px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit</h2>
						</div>
					</div>
	...
	<section class="ftco-intro" style="background-image: url(<?php echo base_url();?>template/images/bg_3.jpg);" data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="col-md-12 tab-wrap">
						...
						<div class="tab-content bg-light p-4 p-md-5 ftco-animate" id="v-pills-tabContent">
							...
							<div class="tab-pane py-2 fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
								<div class="row departments">
									<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
										<div class="img d-flex align-self-stretch" style="background-image: url(<?php echo base_url();?>template/images/dept-1.jpg);"></div>
									</div>
									<div class="col-lg-8">
										<h2>Lorem ipsum</h2>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
										...
										<div class="row mt-5 pt-2">
											<div class="col-lg-6">
												<div class="services-2 d-flex">
													...
													<div class="text">
														<h3>Lorem ipsum</h3>
														<p>FLorem ipsum dolor sit amet, consectetur adipisicing tempor incididunt ut labore et dolore magna aliqua.</p>
													</div>
												</div>
											</div>
											<div class="col-lg-6">
							...
							<div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-day-2-tab">
								<div class="row departments">
									<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
										<div class="img d-flex align-self-stretch" style="background-image: url(<?php echo base_url();?>template/images/dept-2.jpg);"></div>
									</div>
									<div class="col-md-8">
							...
							<div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-day-3-tab">
								<div class="row departments">
									<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
										<div class="img d-flex align-self-stretch" style="background-image: url(<?php echo base_url();?>template/images/dept-3.jpg);"></div>
									</div>
									<div class="col-md-8">
							...
							<div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-day-4-tab">
								<div class="row departments">
									<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
										<div class="img d-flex align-self-stretch" style="background-image: url(<?php echo base_url();?>template/images/dept-4.jpg);"></div>
									</div>
									<div class="col-md-8">
							...
							<div class="tab-pane fade" id="v-pills-5" role="tabpanel" aria-labelledby="v-pills-day-5-tab">
								<div class="row departments">
									<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
										<div class="img d-flex align-self-stretch" style="background-image: url(<?php echo base_url();?>template/images/dept-5.jpg);"></div>
									</div>
									<div class="col-md-8">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(<?php echo base_url();?>template/images/doc-1.jpg);"></div>
						</div>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(<?php echo base_url();?>template/images/doc-2.jpg);"></div>
						</div>
						<div class="text pt-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(<?php echo base_url();?>template/images/doc-3.jpg);"></div>
						</div>
						<div class="text pt-3 text-center">
							<h3>Dr. Ian Smith</h3>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(<?php echo base_url();?>template/images/doc-4.jpg);"></div>
						</div>
						<div class="text pt-3 text-center">
					...
					<div class="carousel-testimony owl-carousel">
						<div class="item">
							<div class="testimony-wrap d-flex">
								<div class="user-img mr-4" style="background-image: url(<?php echo base_url();?>template/images/person_1.jpg)">
								</div>
						...
						<div class="item">
							<div class="testimony-wrap d-flex">
								<div class="user-img mr-4" style="background-image: url(<?php echo base_url();?>template/images/person_2.jpg)">
								</div>
								<div class="text ml-2 bg-light">
									<span class="quote d-flex align-items-center justify-content-center">
										<i class="icon-quote-left"></i>
						...
						<div class="item">
							<div class="testimony-wrap d-flex">
								<div class="user-img mr-4" style="background-image: url(<?php echo base_url();?>template/images/person_3.jpg)">
								</div>
								<div class="text ml-2 bg-light">
									<span class="quote d-flex align-items-center justify-content-center">
										<i class="icon-quote-left"></i>
						...
						<div class="item">
							<div class="testimony-wrap d-flex">
								<div class="user-img mr-4" style="background-image: url(<?php echo base_url();?>template/images/person_4.jpg)">
								</div>
								<div class="text ml-2 bg-light">
									<span class="quote d-flex align-items-center justify-content-center">
										<i class="icon-quote-left"></i>
	...
	<section class="ftco-section ftco-no-pt ftco-no-pb ftco-counter img" id="section-counter" style="background-image: url(<?php echo base_url();?>template/images/bg_3.jpg);" data-stellar-background-ratio="0.5">
		<div class="container">
			<div class="row">
			...
			<div class="row">
				<div class="col-md-4 ftco-animate">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20" style="background-image: url('<?php echo base_url();?>template/images/image_1.jpg');">
				...
				<div class="col-md-4 ftco-animate">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20" style="background-image: url('<?php echo base_url();?>template/images/image_2.jpg');">
							<div class="meta-date text-center p-2">
								<span class="day">23</span>
								<span class="mos">January</span>
								<span class="yr">2019</span>
				...
				<div class="col-md-4 ftco-animate">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20" style="background-image: url('<?php echo base_url();?>template/images/image_3.jpg');">
							<div class="meta-date text-center p-2">
								<span class="day">23</span>
								<span class="mos">January</span>
								<span class="yr">2019</span>
	...
	<footer class="ftco-footer ftco-bg-dark ftco-section">
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-5">
						...
						<div class="block-21 mb-4 d-flex">
							<a class="blog-img mr-4" style="background-image: url(<?php echo base_url();?>template/images/image_1.jpg);"></a>
							<div class="text">
						...
						<div class="block-21 mb-5 d-flex">
							<a class="blog-img mr-4" style="background-image: url(<?php echo base_url();?>template/images/image_2.jpg);"></a>
							<div class="text">
								<h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a></h3>
								<div class="meta">
									<div><a href="#"><span class="icon-calendar"></span> Dec 25, 2018</a></div>
		...
		<script src="<?php echo base_url();?>template/js/jquery-migrate-3.0.1.min.js"></script>
		...
		<script src="<?php echo base_url();?>template/js/jquery.stellar.min.js"></script>
		<script src="<?php echo base_url();?>template/js/owl.carousel.min.js"></script>
		<script src="<?php echo base_url();?>template/js/jquery.magnific-popup.min.js"></script>
		<script src="<?php echo base_url();?>template/js/aos.js"></script>
		<script src="<?php echo base_url();?>template/js/jquery.animateNumber.min.js"></script>
		<script src="<?php echo base_url();?>template/js/bootstrap-datepicker.js"></script>
		<script src="<?php echo base_url();?>template/js/jquery.timepicker.min.js"></script>
		<script src="<?php echo base_url();?>template/js/scrollax.min.js"></script>
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
		<script src="<?php echo base_url();?>template/js/google-map.js"></script>
